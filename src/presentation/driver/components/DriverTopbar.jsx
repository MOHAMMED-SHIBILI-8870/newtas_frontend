...
const titleMap = [
  { prefix: '/driver/dashboard', title: 'Dashboard' },
  { prefix: '/driver/trips', title: 'Assigned Trips' },
  { prefix: '/driver/vehicle', title: 'My Vehicle' },
  { prefix: '/driver/tracking', title: 'Live Tracking' },
  { prefix: '/driver/notifications', title: 'Notifications' },
  { prefix: '/driver/chat', title: 'Chat Workspace' },
  { prefix: '/driver/profile', title: 'My Profile' },
  { prefix: '/driver/schedule', title: 'My Schedule' },
]

export default function DriverTopbar({ onMenuToggle, collapsed, onToggleCollapse }) {
      ...
      <div className="flex items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:block">
            <NotificationBell to="/driver/notifications" variant="dark" />
          </div>
          ...
          <div className="flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-3 py-2">
            ...
            <div className="hidden min-w-0 flex-col sm:flex">
              <span className="truncate text-sm font-semibold text-white">{user?.full_name || user?.email || 'Driver'}</span>
              <span className="text-xs text-white/55">Driver Partner</span>
            </div>
            <button
              type="button"
